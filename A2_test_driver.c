...
int main()
{
    ...
    root=BST_insert(root,new_note);
    new_note=newBST_Node(82.41,1,.75);
    root=BST_insert(root,new_note);
    ...
    new_note=newBST_Node(98.0,2,.45);
    root=BST_insert(root,new_note);
    new_note=newBST_Node(116.54,2,.75);
    root=BST_insert(root,new_note);
    new_note=newBST_Node(38.89,2,.35);
    root=BST_insert(root,new_note);
